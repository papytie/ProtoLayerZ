namespace Game2DWaterKit.Rendering
{
    ...
    public abstract class RenderingModule
    {
        ...
        internal static Camera WaterCamera { get => _g2dwCamera; }

#if GAME_2D_WATER_KIT_LWRP || GAME_2D_WATER_KIT_URP
        internal static Camera CurrentSceneCamera { get; private set; }
#endif
        ...
        internal abstract void ValidateMaterialProperties(Camera currentCamera);
...
#if GAME_2D_WATER_KIT_LWRP || GAME_2D_WATER_KIT_URP
        private static System.Action<UnityEngine.Rendering.ScriptableRenderContext, Camera> _updateCurrentSceneCamera = new System.Action<UnityEngine.Rendering.ScriptableRenderContext, Camera>(UpdateCurrentSceneCamera);
#if UNITY_2023_3_OR_NEWER
        private static void OnBeginFrameRendering(UnityEngine.Rendering.ScriptableRenderContext context, List<Camera> cameras)
#else
        private static void OnBeginFrameRendering(UnityEngine.Rendering.ScriptableRenderContext context, Camera[] cameras)
#endif
        {
            foreach (var camera in cameras)
                RenderObjects(context, camera);

            UnityEngine.Rendering.RenderPipelineManager.beginCameraRendering += _updateCurrentSceneCamera;
        }
#if UNITY_2023_3_OR_NEWER
        private static void OnEndFrameRendering(UnityEngine.Rendering.ScriptableRenderContext context, List<Camera> cameras)
#else
        ...
        private static void UpdateCurrentSceneCamera(UnityEngine.Rendering.ScriptableRenderContext context, Camera currentCamera)
        {
            CurrentSceneCamera = currentCamera;
        }
...
#endif
        {
            ...
            for (int i = 0, imax = _renderingModulesList.Count; i < imax; i++)
            {
                ...
                var currentRenderingCameraInformation = _renderingCameraInformation;
                ...
                {
#if GAME_2D_WATER_KIT_LWRP || GAME_2D_WATER_KIT_URP
                    currentRenderingModule.Render(context, currentRenderingCameraInformation);
#else
...
#if GAME_2D_WATER_KIT_LWRP || GAME_2D_WATER_KIT_URP
#if UNITY_2023_3_OR_NEWER
                UnityEngine.Rendering.RenderPipelineManager.beginContextRendering += OnBeginFrameRendering;
                UnityEngine.Rendering.RenderPipelineManager.endContextRendering += OnEndFrameRendering;
#else
    ...
    internal class RenderingCameraInformation
    {
        ...
        public Vector3 nearFrustumPlaneTopLeft { get; set; }
        public Vector3 nearFrustumPlaneTopRight { get; set; }
        public Vector3 nearFrustumPlaneBottomLeft { get; set; }
        public Vector3 nearFrustumPlaneBottomRight { get; set; }
