...
#if UNITY_EDITOR
        /// <summary>
        /// Method to change the size of a waterKitObject object solely in editor
        /// This method does not work at runtime
        /// </summary>
        /// <param name="waterKitObject">a water or a waterfall gameobject</param>
        /// <param name="newSize">x: new width; y: new height</param>
        public static void SetSize(Game2DWaterKitObject waterKitObject, Vector2 newSize)
        {
            var serializedObject = new SerializedObject(waterKitObject);
            serializedObject.FindProperty("_size").vector2Value = newSize;
            // this applies modified properties with registering an undo operation
            // for applying property modifications without registering an undo operation
            // you may use: serializedObject.ApplyModifiedPropertiesWithoutUndo();
