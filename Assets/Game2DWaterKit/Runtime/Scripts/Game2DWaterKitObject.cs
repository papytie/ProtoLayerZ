namespace Game2DWaterKit
{
    ...
    public abstract class Game2DWaterKitObject : MonoBehaviour
    {
        ...
        protected abstract void WillRenderObjectUpdate(Camera renderingCamera);
#if UNITY_EDITOR
        ...
        private void OnWillRenderObject()
        {
            ...
            var currentCamera = Game2DWaterKit.Rendering.RenderingModule.CurrentSceneCamera;
#else
            var currentCamera = Camera.current;
            if (currentCamera == Game2DWaterKit.Rendering.RenderingModule.WaterCamera)
                return;
#endif
            WillRenderObjectUpdate(currentCamera);
        }
