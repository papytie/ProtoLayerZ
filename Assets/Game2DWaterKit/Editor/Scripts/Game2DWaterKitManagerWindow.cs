namespace Game2DWaterKit
{
    ...
    public class Game2DWaterKitManagerWindow : EditorWindow
    {
        ...
        {
#if UNITY_2019_1_OR_NEWER
            string defineSymbols = GetScriptingDefineSymbols(EditorUserBuildSettings.selectedBuildTargetGroup);
        ...
        {
            var defineSymbols = GetScriptingDefineSymbols(EditorUserBuildSettings.selectedBuildTargetGroup);
        ...
        private static void DrawAssetInformation()
        {
            ...
            GUI.Label(detailsRect, "Game 2D Water Kit v1.4.8 (b30.07.24)", EditorStyles.boldLabel);
        ...
        private static void AddDefineSymbolToAllBuildTargetGroups(string defineSymbol)
        {
            ...
            AddDefineSymbolToBuildTargetGroup(BuildTargetGroup.PS5, defineSymbol);
#endif
        }
...
#if UNITY_2020_3_OR_NEWER
            RemoveDefineSymbolFromBuildTargetGroup(BuildTargetGroup.PS5, defineSymbol);
#endif
        }

        private static void AddDefineSymbolToBuildTargetGroup(BuildTargetGroup buildTargetGroup, string defineSymbol)
        {
            var defineSymbols = GetScriptingDefineSymbols(buildTargetGroup);
            ...
            SetScriptingDefineSymbols(buildTargetGroup, defineSymbols);
        }
